...
var instrucciones = ['Utilizar las flechas del teclado para mover las piezas del rompecabezas.',
...
function AgregaUltimaDireccion(codigoDireccion) {
...
if (chequearSiGano) {
  alert('Felicitaciones!!! Armaste el Rompecabezas!!');
  }
}
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
    ...
    var ValorAux = grilla[filaPos1][columnaPos1];
    grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
    grilla[filaPos2][columnaPos2] = ValorAux;
